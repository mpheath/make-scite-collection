...
_update = {
    ...
    'markdown': [
        ...
        ['style.markdown.6', 'fore:#FF7766,bold,size:12'],
        ['style.markdown.7', 'fore:#FF9966,bold,size:10'],
        ['style.markdown.8', 'fore:#FFBB66,bold,size:8'],
        ['style.markdown.9', 'fore:#FFBB66,bold,size:8'],
        ['style.markdown.10', 'fore:#FFDD66,bold,size:8'],
        ['style.markdown.11', 'fore:#FFDD66,bold,size:8'],
